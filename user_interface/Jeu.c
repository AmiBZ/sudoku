...
{
    int i=0,j=0,x,y,compteur,fin=0,tempsEcoule=1,tempsPrecedent=120,tempsActuel=0;
    int grille[4][4]={0};
    int grille2[4][4]={0};
    ...
    while (continuer)
    {
        ...
        case SDL_MOUSEBUTTONDOWN:
            ...
            //rejouer
            if ((event.button.x>300&& event.button.x<520)&&(event.button.y>600 && event.button.y<800))
            {
